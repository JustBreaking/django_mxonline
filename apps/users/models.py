...
class UserProfile(AbstractUser):
    ...
    image = models.ImageField(upload_to="image/%Y/%m", default = u'image/default.png', max_length=64)
...
class EmailVerfyRecord(models.Model):
    ...
    send_type = models.CharField(verbose_name=u'验证码类型', max_length=16, choices=(('register',u'注册'),('forget',u'找回密码')))
