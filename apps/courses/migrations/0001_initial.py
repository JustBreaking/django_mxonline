# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2017-06-19 00:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[(b'cj', '\u521d\u7ea7'), (b'zj', '\u4e2d\u7ea7'), (b'gj', '\u9ad8\u7ea7')], max_length=2)),
                ('learn_time', models.IntegerField(default=0, verbose_name='\u5b66\u4e60\u65f6\u957f\uff08\u5206\u949f\u6570\uff09')),
                ('students', models.IntegerField(default=0, verbose_name='\u5b66\u4e60\u4eba\u6570')),
                ('fav_nums', models.IntegerField(default=0, verbose_name='\u6536\u85cf\u4eba\u6570')),
                ('image', models.ImageField(max_length=64, upload_to=b'courses/%Y/%m', verbose_name='\u5c01\u9762\u56fe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download', models.FileField(max_length=64, upload_to=b'course/resource/%Y%m', verbose_name='\u8d44\u6e90\u6587\u4ef6')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
